...
const OperationsDashboard = ({ userRole }) => {
  ...
  // Fetch operations documents
  const fetchOperationsDocuments = async () => {
    try {
      setLoading(true);
      let url = `${API_BASE_URL}/documents/department/operations`;
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch operations documents');
      }
      ...
      console.error('Error fetching operations documents:', err);
      setError('Failed to load operations documents');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Operational procedures, maintenance docs, and process guidelines
              </p>
            </div>
          </div>
        </div>
        <div className="flex items-center space-x-4 mt-4 sm:mt-0">
          <button 
            onClick={fetchOperationsDocuments}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Operations Documents</h2>
        </div>
        
        <div className="max-h-96 overflow-y-auto">
          {loading && (
            <div className="p-8 text-center">
              <RefreshCw className="h-8 w-8 text-orange-500 mx-auto mb-4 animate-spin" />
              <p className="text-gray-600">Loading operations documents...</p>
            </div>
          )}
            ...
            <div className="divide-y divide-gray-200">
              {documents.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">No operations documents found</p>
                  <p className="text-sm text-gray-500">
                    Upload operational procedures and maintenance docs to get started.
                  </p>
                </div>
              ) : (
                documents
                  ...
                  .map((doc) => (
                    <div key={doc.id} className="p-6 border-l-4 border-l-orange-500">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-500">
                            <span>{doc.subject || 'Operations Document'}</span>
                            <span>•</span>
