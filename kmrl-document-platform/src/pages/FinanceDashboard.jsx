...
const FinanceDashboard = ({ userRole }) => {
  ...
  const fetchFinanceDocuments = async () => {
    try {
      setLoading(true);
      let url = `${API_BASE_URL}/documents/department/finance`;
      ...
      setError('Failed to load finance documents');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Financial reports, budgets, invoices, and accounting documents
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Finance Documents</h2>
        </div>
        ...
        <div className="max-h-96 overflow-y-auto">
          {loading && (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600">Loading finance documents...</p>
            </div>
          )}
          ...
          {!loading && !error && (
            <div className="divide-y divide-gray-200">
              {documents.length === 0 ? (
                <div className="p-8 text-center">
                  <DollarSign className="h-8 w-8 text-gray-400 mx-auto mb-4" />
                  <p className="text-gray-600 mb-4">No finance documents found</p>
                  <p className="text-sm text-gray-500">
                    Upload financial reports and budgets to get started.
                  </p>
                </div>
              ) : (
                documents
                  ...
                  .map((doc) => (
                    <div key={doc.id} className="p-6 border-l-4 border-l-green-500">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-500">
                            <span>{doc.subject || 'Finance Document'}</span>
                            <span>•</span>
