...
const EngineeringDashboard = ({ userRole }) => {
  ...
  // Fetch engineering documents
  const fetchEngineeringDocuments = async () => {
    try {
      setLoading(true);
      let url = `${API_BASE_URL}/documents/department/engineering`;
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch engineering documents');
      }
      ...
      console.error('Error fetching engineering documents:', err);
      setError('Failed to load engineering documents');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Technical documents, specifications, and engineering resources
              </p>
            </div>
          </div>
        </div>
        <div className="flex items-center space-x-4 mt-4 sm:mt-0">
          <button 
            onClick={fetchEngineeringDocuments}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-900">Engineering Documents</h2>
        ...
        <div className="max-h-96 overflow-y-auto">
          {loading && (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600">Loading engineering documents...</p>
            </div>
          )}
              ...
              {filteredDocuments.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500">
                    {documents.length === 0 
                      ? "Upload technical documents to get started."
                      : "Try adjusting your search or filter criteria."}
                  </p>
                  {hasActiveFilters && (
                    <button
                      onClick={clearFilters}
                      className="mt-3 px-4 py-2 text-blue-600 hover:text-blue-800 border border-blue-300 rounded-lg hover:bg-blue-50"
                    >
                      Clear Filters
                    </button>
                  )}
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-500">
                            <span>{doc.subject || 'Technical Document'}</span>
                            <span>•</span>
